...
1. **管理类功能采用权限点控制。**检查模板、模板匹配、合规人员库、互查/稽查发起与派发和系统配置等能力均配置独立权限点；台账权限点不在本PRD负责范围内。
...
| 局管理员     | PG-001 统一工作台 | PG-002、PG-014、PG-020、PG-021、PG-070 至 PG-077、PG-004；其中配置页面按权限点显示 |
