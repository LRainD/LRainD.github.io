...
const Component = () => {
  ...
  const reviewAttachments = [
    { id: 1, name: '授权委托书（非法人投标需上传代理人社保证明）', template: '采购公告授权委托书模板.docx', file: '报名资料.pdf' },
    { id: 2, name: '营业执照', template: '', file: '报名资料.pdf' },
    { id: 3, name: '资质证书', template: '', file: '报名资料.pdf' },
    { id: 4, name: '安全施工许可证', template: '', file: '报名资料.pdf' },
    { id: 5, name: '其他附件', template: '', file: '报名资料.pdf' },
  ];

  // 弹窗中的资格审查条件数据
  const reviewConditions = [
    { id: 1, item: '未在失信被执行企业名单', name: '未在失信被执行企业名单', category: '风险类', intensity: '强制条件', method: '系统', source: '第三方数据', issuer: '--', result: '通过', reason: '', basis: '', operation: '--' },
    { id: 2, item: '未在严重违法失信企业名单', name: '未在严重违法失信企业名单', category: '风险类', intensity: '强制条件', method: '系统', source: '第三方数据', issuer: '--', result: '通过', reason: '', basis: '', operation: '--' },
                  ...
                  <table className="w-full text-xs text-left">
                    <thead className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-medium">
                      <tr>
                        ...
                        <th className="p-3 border-r border-gray-200 dark:border-gray-600">资格审查条件项</th>
                        <th className="p-3 border-r border-gray-200 dark:border-gray-600">资格审查条件名称</th>
