                ...
                <div className="flex items-center mb-4">
                  ...
                  <label className="inline-flex items-center mr-4 cursor-pointer">
                    <input
                      type="radio"
                      name="noticeFormat"
                      checked={noticeFormat === 'template'}
                      onChange={() => setNoticeFormat('template')}
                      className="text-primary focus:ring-primary h-4 w-4 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700 dark:text-gray-300 text-sm">范本</span>
                  </label>
                  <label className="inline-flex items-center cursor-pointer">
                    <input
                      type="radio"
                      name="noticeFormat"
                      checked={noticeFormat === 'richtext'}
                      onChange={() => setNoticeFormat('richtext')}
                      className="text-primary focus:ring-primary h-4 w-4 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700 dark:text-gray-300 text-sm">富文本</span>
                  </label>
                </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <label className="inline-flex items-center mr-4 cursor-pointer">
                    <input
                      type="radio"
                      name="qualAttachment"
                      checked={isQualAttachmentSet}
                      onChange={() => setIsQualAttachmentSet(true)}
                      className="text-primary focus:ring-primary h-4 w-4 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700 dark:text-gray-300 text-sm">是</span>
                  </label>
                  <label className="inline-flex items-center cursor-pointer">
                    <input
                      ...
                      name="qualAttachment"
                      checked={!isQualAttachmentSet}
                      onChange={() => setIsQualAttachmentSet(false)}
                      className="text-primary focus:ring-primary h-4 w-4 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700 dark:text-gray-300 text-sm">否</span>
                  </label>
                ...
                {isQualAttachmentSet && (
                  <>
                    ...
                    <div className="mt-6">
                      <div className="flex items-center mb-4">
                        <span className="text-gray-700 dark:text-gray-300 text-sm mr-4">是否设定AI辅助报名文件检测：</span>
                        <label className="inline-flex items-center mr-4 cursor-pointer">
                          <input
                            type="radio"
                            name="auxFileDetect"
                ...
                <div className="flex items-center mb-4">
                  ...
                  <label className="inline-flex items-center mr-4 cursor-pointer">
                    <input
                      type="radio"
                      name="qualCondition"
                      checked={isQualConditionSet}
                      onChange={() => setIsQualConditionSet(true)}
                      className="text-primary focus:ring-primary h-4 w-4 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700 dark:text-gray-300 text-sm">是</span>
                  </label>
                  <label className="inline-flex items-center cursor-pointer mr-4">
                    <input
                      ...
                      name="qualCondition"
                      checked={!isQualConditionSet}
                      onChange={() => setIsQualConditionSet(false)}
                      className="text-primary focus:ring-primary h-4 w-4 border-gray-300"
                    />
                    <span className="ml-2 text-gray-700 dark:text-gray-300 text-sm">否</span>
                  </label>
