...
const Component = () => {
  ...
  const [reviewResults, setReviewResults] = useState([
    { id: 1, item: '营业执照', importance: '必须符合', result: '通过', requirement: '营业执照须在有效期内且已完成年检', suggestion: '' },
    { id: 2, item: '安全生产许可证', importance: '必须符合', result: '未通过', requirement: '须持有有效的安全生产许可证', suggestion: '安全生产许可证已过期，请供应商及时办理续期并重新上传' },
    { id: 3, item: '授权委托书', importance: '必须符合', result: '待核实', requirement: '授权委托书须加盖公章及法人签字', suggestion: '系统超时，未能完成自动校验，请人工核实' },
  ]);
          ...
          <div className="bg-white dark:bg-gray-800 w-full max-w-6xl rounded-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="flex-1 overflow-auto custom-scrollbar p-6">
              ...
              <div className="mt-6">
                <div className="flex items-center mb-3">
                  <div className="w-1 h-4 bg-primary mr-2"></div>
                  <h3 className="font-bold text-gray-800 dark:text-white text-sm">AI辅助报名文件检测</h3>
                </div>
                <div className="border border-gray-200 dark:border-gray-700 rounded overflow-hidden">
                  <table className="w-full text-xs text-left">
                    <thead className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-medium">
